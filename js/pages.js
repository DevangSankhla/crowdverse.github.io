    ...
    <div class="section">
      ...
      <div class="steps-grid">
        <div class="step-card">
          ...
          <img src="assets/Token.png" alt="Tokens" class="step-icon-img" style="width:48px;height:48px;object-fit:contain;margin-bottom:0.75rem;">
        ...
        <div class="step-card">
          ...
          <img src="assets/Markets.png" alt="Predict" class="step-icon-img" style="width:48px;height:48px;object-fit:contain;margin-bottom:0.75rem;">
        ...
        <div class="step-card">
          ...
          <img src="assets/Rewards.png" alt="Win" class="step-icon-img" style="width:48px;height:48px;object-fit:contain;margin-bottom:0.75rem;">
          <h3>Win & Redeem</h3>
  ...
  document.getElementById('page-community').innerHTML = `
    ...
    <div style="max-width:600px;margin:0 auto;padding:0 2rem 3rem;">
      ...
      ` : State.userTokens < MARKET_SUBMISSION_COST ? `
        <!-- Not enough tokens -->
        <div style="background:var(--off-black);border:1px solid var(--border);border-radius:var(--radius-lg);padding:2.5rem;text-align:center;">
          <img src="assets/Token.png" alt="Tokens" style="width:64px;height:64px;margin-bottom:1rem;">
          <h3 style="font-family:var(--font-display);font-size:1.1rem;font-weight:700;margin-bottom:0.5rem;">Not Enough Tokens</h3>
          <p style="color:var(--white2);font-size:0.85rem;margin-bottom:1rem;">You need <strong>${MARKET_SUBMISSION_COST} <img src="assets/Token.png" style="width:14px;height:14px;vertical-align:middle;"></strong> to submit a market.</p>
        ...
        <div style="background:var(--off-black);border:1px solid var(--border);border-radius:var(--radius-lg);padding:1.5rem;">
          <div style="margin-bottom:1.5rem;">
            ...
            <p style="color:var(--white2);font-size:0.83rem;line-height:1.55;">
              Cost: <strong style="color:var(--green);">${MARKET_SUBMISSION_COST} <img src="assets/Token.png" style="width:14px;height:14px;vertical-align:middle;"></strong>. 
          ...
          <div style="background:var(--dark);padding:0.75rem 1rem;border-radius:8px;margin-bottom:1rem;
            ...
            &nbsp;·&nbsp; Fee: <strong>${MARKET_SUBMISSION_COST} <img src="assets/Token.png" style="width:12px;height:12px;vertical-align:middle;"></strong>
          </div>

          <button class="btn btn-primary w-full" onclick="submitCreateMarketDirect()">
            Submit Market (${MARKET_SUBMISSION_COST} <img src="assets/Token.png" style="width:12px;height:12px;vertical-align:middle;">)
          </button>
  ...
  document.getElementById('page-markets').innerHTML = `
    ...
    <div style="max-width:1100px;margin:0 auto;padding:0 2rem 3rem;">
      ...
      <div style="display:flex;gap:0.5rem;flex-wrap:wrap;margin-bottom:1.25rem;" id="market-filters">
        ...
        <button class="mkt-filter-btn" data-filter="sports" onclick="applyMarketFilter('sports')"><img src="assets/Sports.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Sports</button>
        <button class="mkt-filter-btn" data-filter="economy" onclick="applyMarketFilter('economy')"><img src="assets/Economy.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Economy</button>
        <button class="mkt-filter-btn" data-filter="entertainment" onclick="applyMarketFilter('entertainment')"><img src="assets/Entertainment.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Entertainment</button>
        <button class="mkt-filter-btn" data-filter="technology" onclick="applyMarketFilter('technology')"><img src="assets/Tech.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Tech</button>
        <button class="mkt-filter-btn" data-filter="crypto" onclick="applyMarketFilter('crypto')"><img src="assets/Crypto.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Crypto</button>
        <button class="mkt-filter-btn" data-filter="climate" onclick="applyMarketFilter('climate')"><img src="assets/Climate.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Climate</button>
      </div>
  ...
  modal.innerHTML = `
    <div class="modal" style="max-width:500px;">
      ...
      <p style="color:var(--white2);margin-bottom:1.5rem;font-size:0.83rem;line-height:1.5;">
        ...
        <strong style="color:var(--green);opacity:0.9;">20 <img src="assets/Token.png" style="width:12px;height:12px;vertical-align:middle;"></strong>.
      ...
      <div style="background:var(--white1);padding:0.75rem 1rem;border-radius:8px;margin-bottom:1rem;
        ...
        &nbsp;·&nbsp; Submission fee: <strong>20 <img src="assets/Token.png" style="width:12px;height:12px;vertical-align:middle;"></strong>
      </div>

      <button class="btn btn-primary w-full" onclick="submitCreateMarket()">
        Submit Poll (20 <img src="assets/Token.png" style="width:12px;height:12px;vertical-align:middle;">)
      </button>
    </div>
  `;
...
async function submitCreateMarket() {
  ...
  const catIcons = {
    sports: '<img src="assets/Sports.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Sports',
    economy: '<img src="assets/Economy.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Economy',
    entertainment: '<img src="assets/Entertainment.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Entertainment',
    technology: '<img src="assets/Tech.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Technology',
    climate: '<img src="assets/Climate.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Climate',
    crypto: '<img src="assets/Crypto.png" style="width:16px;height:16px;vertical-align:middle;margin-right:4px;">Crypto'
  };
    ...
    <div id="profile-logged-in" style="display:none">
      ...
      <div class="profile-layout">
          ...
          <div class="profile-card">
            ...
            <div id="profile-name-edit" style="display:none;margin-bottom:0.5rem;">
              ...
              <div style="display:flex;gap:0.5rem;">
                <button onclick="if(confirm('Are you sure? This will deduct 50 tokens.')) saveUsername();" class="btn btn-primary" style="flex:1;padding:0.5rem;">Save (50 <img src="assets/Token.png" style="width:12px;height:12px;vertical-align:middle;">)</button>
            ...
            <div class="token-display" style="margin-top:1rem;">
              ...
              <div>
                <img src="assets/Token.png" style="width:24px;height:24px;vertical-align:middle;margin-right:6px;">
        ...
        <div class="profile-stats">
          <div class="stat-box">
            <h3><img src="assets/Markets.png" style="width:20px;height:20px;vertical-align:middle;margin-right:6px;"> Your Stats</h3>
          ...
          <div class="stat-box">
            <h3><img src="assets/Submit.png" style="width:20px;height:20px;vertical-align:middle;margin-right:6px;"> Your Predictions</h3>
